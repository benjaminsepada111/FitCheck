...
class ChallengeService {
  ...
  static Future<bool> createChallenge(Challenge challenge) async {
    try {
      ...
      print('Challenge created successfully: ${challenge.title}');
      return true;
    } catch (e) {
  ...
  static Future<bool> updateChallenge(Challenge challenge) async {
    try {
      ...
      print('Challenge updated successfully: ${challenge.title}');
      return true;
    } catch (e) {
  ...
  static Future<bool> deleteChallenge(String challengeId) async {
    try {
      ...
      await batch.commit();
      print('Challenge deleted successfully: $challengeId');
      return true;
    } catch (e) {
  ...
  static Future<bool> saveChallengeDay(String challengeId, ChallengeDay day) async {
    try {
      ...
      print('Challenge day saved: $challengeId/day${day.dayNumber}');
      return true;
    } catch (e) {
      print('Error saving challenge day: $e');
      return false;
    }
  }
  ...
  static Future<List<ChallengeDay>> getChallengeDays(String challengeId) async {
    try {
      ...
      print('Error getting challenge days: $e');
      return [];
    }
  }
  ...
  static Future<bool> completeChallengeDay(String challengeId, String dayId) async {
    try {
      ...
      print('Challenge day completed: $challengeId/$dayId');
      return true;
    } catch (e) {
